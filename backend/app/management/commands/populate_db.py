...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        database_url = "postgresql://{user}:{password}@ec2-44-195-201-3.compute-1.amazonaws.com/{database_name}".format(
            user=user,
            password=password,
        ...
        s_and_p_df.to_sql("app_sandp500", con=engine, if_exists="replace", index=False)
