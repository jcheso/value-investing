# Generated by Django 3.2.6 on 2021-08-15 23:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(default='key', max_length=255, primary_key=True, serialize=False)),
                ('date', models.CharField(default=django.utils.timezone.now, max_length=255)),
                ('symbol', models.CharField(max_length=255)),
                ('reportedCurrency', models.CharField(default='USD', max_length=255)),
                ('fillingDate', models.CharField(default=django.utils.timezone.now, max_length=255)),
                ('acceptedDate', models.CharField(default=django.utils.timezone.now, max_length=255)),
